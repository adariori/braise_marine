...
<body class="antialiased bg-stone-50 text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-80 bg-white border-l border-gray-200 shadow-lg sticky top-0 h-screen overflow-y-auto">
            <div class="p-5 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-sm">Menu Admin</h3>
        ...
        <main class="flex-1 px-6 py-8">
            ...
            <section id="section-statistiques" class="section-content">
                <h2 class="text-3xl font-bold text-tropical-green mb-6">Statistiques</h2>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    <div class="bg-white rounded-super shadow-sm border border-gray-100 p-6">
            ...
            <section id="section-plats" class="section-content hidden">
                <h2 class="text-3xl font-bold text-tropical-green mb-6">Gestion des plats</h2>
            ...
            <section id="section-annonces" class="section-content hidden">
                <h2 class="text-3xl font-bold text-tropical-green mb-6">Gestion des annonces</h2>

                <div class="bg-white rounded-super shadow-sm border border-gray-100 p-8 mb-8">
                    <h3 id="form-annonce-titre" class="text-xl font-bold mb-6">Ajouter une annonce</h3>
            ...
            <section id="section-accompagnements" class="section-content hidden">
                <h2 class="text-3xl font-bold text-tropical-green mb-6">Gestion des accompagnements</h2>

                <!-- Formulaire ajout/modification accompagnement -->
                <div class="bg-white rounded-super shadow-sm border border-gray-100 p-8 mb-8">
                    <h4 id="form-accompagnement-titre" class="text-xl font-bold mb-6">Ajouter un accompagnement</h4>
                    <form id="form-accompagnement" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <input type="hidden" id="accompagnement-id">
                        <div>
                            <label class="block text-sm font-semibold mb-1">Nom de l'accompagnement</label>
                            <input type="text" id="accompagnement-nom" required placeholder="Ex: Frites maison"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-braise outline-none transition">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-1">Prix supplément (FCFA)</label>
                ...
                <div class="hidden md:block bg-white rounded-super shadow-sm border border-gray-100 overflow-x-auto mb-8">
                    <table class="w-full text-sm min-w-[700px]">
                        <thead class="bg-stone-50 text-gray-600 font-semibold">
                            <tr>
                                <th class="px-6 py-4 text-left">#</th>
                ...
                <div class="mt-12 border-t-2 border-gray-200 pt-8">
                    <h3 class="text-2xl font-bold text-tropical-green mb-6">Associer des accompagnements à un plat</h3>

                    <div class="bg-white rounded-super shadow-sm border border-gray-100 p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label class="block text-sm font-semibold mb-1">Choisir un plat</label>
                                <select id="plat-accompagnement-select" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-braise outline-none transition bg-white">
                        ...
                        <div id="accompagnements-disponibles" class="mt-6">
                            ...
                            <div id="liste-accompagnements-plat" class="space-y-2 max-h-96 overflow-y-auto border border-gray-200 rounded-xl p-4 bg-gray-50">
